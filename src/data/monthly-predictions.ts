...
export const monthlyPredictions: VedicReading = {
  "birth_details": {
    ...
    "challenges_and_remedies": {
      ...
      "remedies": {
        ...
        "astrological_recommendations": [
          ...
          "Donating black sesame seeds on Saturdays can help mitigate Saturn’s restrictive effects."
        ]
      }
    },
    "major_life_periods": {
  ...
  "content": [
    ...
    },
    {
      ...
      "content": {
        ...
        "marriage": {
          "prediction": "Marriage brings stability and emotional depth.",
          "partner_traits": ["intelligent", "responsible"],
          "challenges": "Communication styles need balancing."
        },
        "romantic_influences": "Strong need for deep emotional connection."
      }
    }
  ]
}

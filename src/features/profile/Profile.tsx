...
export function Profile() {
  ...
  return (
    <div className="relative z-20 pb-20">
      {/* Birth Details Card */}
      <div className="group relative mb-6 bg-white px-8 py-6 backdrop-blur-sm transition-all duration-300 hover:scale-[1.01] hover:bg-white/95 dark:bg-gray-900 dark:hover:bg-gray-900/95">
